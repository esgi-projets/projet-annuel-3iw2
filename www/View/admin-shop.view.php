  ...
  <div class="row">
    <div class="col-12-xl col-12-lg col-12-md col-12-sm col-12-xs px-8 pt-2">
      ...
      <label class="button-icon mb-8">
        ...
        <div class="col-4-xl col-4-lg col-4-md hidden-sm hidden-xs">Le slogan sera visble dans le menu. En quelques mots, décrivez la raison d’être de ce site.</div>
      </label>
      <label class="button-icon mb-8">
      ...
      <label class="button-icon mb-8">
        <div class="col-2-xl col-2-lg col-2-md col-4-sm col-4-xs color-gray">Maintenance</div>
        <div class="col-6-xl col-6-lg col-6-md col-6-sm col-6-xs">
          <label class="switch ml-5">
            <input type="checkbox">
            <span class="slider round"></span>
        ...
        <div class="col-4-xl col-4-lg col-4-md hidden-sm hidden-xs">Vous pouvez utiliser ce mode pour désactiver l’affichage du site aux utilisateurs non-administrateur.</div>
      </label>
      <label class="button-icon mb-8">
