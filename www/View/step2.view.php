<div class="col-12-xl col-12-lg col-12-md col-12-sm col-12-xs">
  <h1 class="font-600 color-dark">Étape <span class="color-primary">2/3</span> - Réglages</h1>
  <h2 class="font-600 color-gray mt-4 ml-4">Cette section permet d'assigner un rôle à votre futur compte et de définir des paramètres de votre site.</h2>
  ...
  <form enctype="multipart/form-data" action="" method="POST">
    ...
    <div class="col-12-xl col-12-lg col-12-md col-12-sm col-12-xs px-8 mt-8">
      <label class="button-icon mb-8">
        <div class="col-2-xl col-2-lg col-2-md col-6-sm col-6-xs color-gray">L'adresse e-mail de votre compte</div>
        <div class="col-6-xl col-6-lg col-6-md col-12-sm col-12-xs">
          <input name="email_grant" type="email" class="w-80" required></input>
        </div>
        <div class=" col-4-xl col-4-lg col-4-md hidden-sm hidden-xs color-error">Une fois l'installation terminée, vous devrez vous inscrire avec cette adresse e-mail et votre compte sera automatiquement administrateur.</div>
      </label>
      <label class="button-icon mb-8">
        <div class="col-2-xl col-2-lg col-2-md col-6-sm col-6-xs color-gray">Titre du site</div>
        <div class="col-6-xl col-6-lg col-6-md col-12-sm col-12-xs">
          <input name="title" type="text" class="w-80" required></input>
        </div>
      ...
      <label class="button-icon mb-8">
        ...
        <div class="col-6-xl col-6-lg col-6-md col-12-sm col-12-xs">
          <input name="slogan" type="text" class="w-80" required></input>
        </div>
      ...
      <label class="button-icon mb-8">
        ...
        <div class="col-6-xl col-6-lg col-6-md col-12-sm col-12-xs">
          <textarea name="description" class="w-80 h-10 px-3" rows="10" cols="80" required></textarea>
        </div>
      ...
      <label class="button-icon mb-8">
        ...
        <div class="col-6-xl col-6-lg col-6-md col-6-sm col-6-xs">
          <label class="switch ml-5">
            <input name="allow_reviews" type="checkbox">
      ...
      <label class="button-icon mb-8">
        ...
        <div class="col-6-xl col-6-lg col-6-md col-6-sm col-6-xs">
          <label class="switch ml-5">
            <input name="visibility_search_engine" type="checkbox">
            <span class="slider round"></span>
          </label>
        </div>
      </label>
    ...
    <div class="col-12-xl col-12-lg col-12-md col-12-sm col-12-xs pl-4 pr-4 pb-4">
      ...
      <label class="button-icon pl-4 mb-4 mt-8">
        ...
        <div class="col-6-xl col-6-lg col-6-md col-12-sm col-12-xs">
          <input name="stripe_public_key" class="w-80" placeholder="pk_test_..."></input>
        </div>
      ...
      <label class="button-icon pl-4 mb-4 mt-8">
        ...
        <div class="col-6-xl col-6-lg col-6-md col-12-sm col-12-xs">
          <input name="stripe_private_key" class="w-80" placeholder="sk_test_..."></input>
        </div>
      ...
      <label class="button-icon pl-4 mb-4 mt-8">
        ...
        <div class="col-6-xl col-6-lg col-6-md col-12-sm col-12-xs">
          <select name="currency" class="w-80">
            ...
            <option value="AUD">Dollars Australiens</option>
            <option value="NZD">Dollars Nez-Zélandais</option>
            <option value="JPY">Yens</option>
            <option value="PLN">Zlotych</option>
      ...
      <label class="button-icon pl-4 mb-4 mt-8">
        ...
        <div class="col-6-xl col-6-lg col-6-md col-12-sm col-12-xs">
          <input name="smtp_email" class="w-80" placeholder="admin@cms.fr" required></input>
        </div>
      ...
      <label class="button-icon pl-4 mb-4 mt-8">
        ...
        <div class="col-6-xl col-6-lg col-6-md col-12-sm col-12-xs">
          <input name="smtp_url" class="w-80" placeholder="smtp.example.com" required></input>
        </div>
      ...
      <label class="button-icon pl-4 mb-4 mt-8">
        ...
        <div class="col-6-xl col-6-lg col-6-md col-12-sm col-12-xs">
          <input name="smtp_port" class="w-80" placeholder="587" required></input>
        </div>
      ...
      <label class="button-icon pl-4 mb-4 mt-8">
        ...
        <div class="col-6-xl col-6-lg col-6-md col-12-sm col-12-xs">
          <input name="smtp_username" class="w-80" placeholder="username" required></input>
        </div>
      ...
      <label class="button-icon pl-4 mb-4 mt-8">
        ...
        <div class="col-6-xl col-6-lg col-6-md col-12-sm col-12-xs">
          <input name="smtp_password" class="w-80" placeholder="password" required></input>
        </div>
    ...
    <div class="col-12-xl col-12-lg col-12-md col-12-sm col-12-xs pl-4 pr-4 pb-4">
      ...
      <label class="button-icon pl-4 mb-4 mt-8">
        ...
        <div class="col-6-xl col-6-lg col-6-md col-12-sm col-12-xs">
          <input name="twitter_link" class="w-80" placeholder="https://twitter.com/..."></input>
        </div>
      ...
      <label class="button-icon pl-4 mb-4 mt-8">
        ...
        <div class="col-6-xl col-6-lg col-6-md col-12-sm col-12-xs">
          <input name="facebook_link" class="w-80" placeholder="https://facebook.com/..."></input>
        </div>
      ...
      <label class="button-icon pl-4 mb-4 mt-8">
        ...
        <div class="col-6-xl col-6-lg col-6-md col-12-sm col-12-xs">
          <input name="instagram_link" class="w-80" placeholder="https://instagram.com/..."></input>
        </div>
      ...
      <label class="button-icon pl-4 mt-12 mb-8">
        ...
        <div class="col-6-xl col-6-lg col-6-md col-12-sm col-12-xs">
          <input name="link_terms" type="text" class="w-80" placeholder="https://..."></input>
        </div>
      ...
      <label class="button-icon pl-4 mt-12 mb-8">
        ...
        <div class="col-6-xl col-6-lg col-6-md col-12-sm col-12-xs">
          <input name="link_privacy" type="text" class="w-80" placeholder="https://..."></input>
        </div>
      ...
      <input type="submit" class="button button-primary w-100 h-10 mt-8 mb-8" value="Terminer l'installation"></input>
    </div>
  </form>
</div>