<div class="row">
  <div class="col-3-xl hidden-under-xl bg-white column container-menu">
    ...
    <div class="pl-8 pt-3">
      ...
      <button class="button button-secondary--menu button-icon w-70 ml-5">
        <svg xmlns="http://www.w3.org/2000/svg" style="width: 24px; height:24px;" class="mr-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                ...
                <tr>
                  <th scope="col">
                    <div class="icon pl-10">
                      Date
                      <svg xmlns="http://www.w3.org/2000/svg" style="width: 20px; height:20px;" class="ml-2" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 9l-7 7-7-7" />
                      </svg>
                    </div>
                  </th>
